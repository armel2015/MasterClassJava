...
public class MainStockList {
    ...
    public static void main(String[] args) {
        ...
        Basket armelBasket = new Basket("Armel");
        sellItem(armelBasket, "cup", 100);
        sellItem(armelBasket, "juice", 5);
        removeItem(armelBasket, "cup", 1);
        System.out.println(armelBasket);
